<?php
 session_start();
    ...
    $_SESSION["login"] = $_SESSION["Role"];
        ...
        $query = "SELECT * FROM done_activities where user_id = ".$_SESSION["id"]." ORDER BY Date";
        ...
        <?php while($row = mysqli_fetch_assoc($result)) { ?>  
          <div class="show">
            <h1><?php echo $row['Name']; ?></h1><br>
                    ...
                    <h3>OOTD: <?php echo $row['ootd']; ?></h3>
                    <h3>Remarks: <?php echo $row['remarks']; ?></h3><br><br>           
                    <b><a href="staff_home.php">Back</a></b><br><br>   
          </div>
          <br><br>
        <?php
          } 
